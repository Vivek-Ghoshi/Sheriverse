...
const Login = () => {
  ...
  return (
    <div className="login flex justify-center items-center bg-black max-h-screen h-screen">
      <div className="max-w-md w-full bg-white shadow-2xl rounded-2xl p-10 transform transition-all duration-300 hover:scale-[1.02]">
        ...
        <form onSubmit={handleSubmit(loginHandler)} noValidate>
          ...
          <input
            ...
            className={`w-full h-full mb-1 rounded-lg outline-none border-2 px-10 py-3 text-zinc-600 font-semibold ${
          ...
          <button
            type="submit"
            disabled={!isValid}
            className={`w-full py-3 mt-4 rounded-lg text-white font-semibold transition-all duration-300 transform ${
              isValid
                ? "bg-[#22C55E] hover:bg-[#FF6B81] hover:scale-105"
        ...
        <p className="mt-6 text-center text-gray-500">
          ...
          <Link
            to={"/register"}
            className="text-[#457B9D] font-medium hover:underline transition-all"
          >
            Register here
          </Link>
        </p>
